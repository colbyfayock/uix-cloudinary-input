import type { FormState, FieldState, FieldSubscription, Subscriber, FormSubscription } from './type-helpers/form';
import type { IExtensionDeclaration, ConfigFields, ExtensionPropsBase } from './base';
...
export declare enum FieldExtensionFeature {
...
export interface FieldExtensionProps extends ExtensionPropsBase {
    ...
    setFieldsVisibility: (arg: VisibilityMap | ((currentVisibilityMap: VisibilityMap) => VisibilityMap)) => void;
    /**
